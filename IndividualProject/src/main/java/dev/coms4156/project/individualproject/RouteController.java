...
public class RouteController {
   ...
   *                   the details of the course and an HTTP 200 response or,
   ...
   *
   * @return           A {@code ResponseEntity} object containing either
   *                   the requested information and an HTTP 200 response or,
   *                   an appropriate message indicating the proper response.
   */
   ...
   *
   * @return           A {@code ResponseEntity} object containing either
   *                   the location of the course and an HTTP 200 response or,
   *                   an appropriate message indicating the proper response.
   */
  ...
  public ResponseEntity<?> addMajorToDept(@RequestParam(value = "deptCode") String deptCode) {
    try {
      ...
      if (doesDepartmentExists) {
        ...
        specifiedDept.increaseNumberOfMajors();
  ...
  public ResponseEntity<?> removeMajorFromDept(@RequestParam(value = "deptCode") String deptCode) {
    try {
      ...
      if (doesDepartmentExists) {
        ...
        Department specifiedDept = departmentMapping.get(deptCode);
        specifiedDept.decreaseNumberOfMajors();
  ...
  /**
   * Attempts to set enrollment count of the specified course to the given number.
   *
   * @param deptCode       A {@code String} representing the department.
   *
   * @param courseCode     A {@code int} representing the course within the department.
